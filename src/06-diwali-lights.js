...
export function diwaliLightsPlan(lightStrings, budget) {
  ...
  for (const light of lightStrings) {
    ...
    if (light.color === "golden") pricePerMeter = 50;
    else if (light.color === "multicolor") pricePerMeter = 40;
    else if (light.color === "white") pricePerMeter = 30;
    else pricePerMeter = 35;

    const cost = light.length * pricePerMeter;
